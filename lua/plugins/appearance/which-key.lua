...
local function preset_icon(category, keys, description)
  ...
  elseif category == 'text_objects' then
    return { icon = keys == 'a' and '󰏫 ', color = 'purple' }
    ...
    opts = function()
      return {
        ...
        spec = {
          ...
          { '<leader>q', icon = { icon = '󱖫 ', color = 'red' } },
          { '<leader>Q', icon = { icon = '󱖫 ', color = 'red' }, desc = 'Workspace Diagnostics' },
          ...
          { '<leader>a', group = 'AI', icon = { icon = '󰚩 ', color = 'purple' }, mode = { 'n', 'x' } },
          { '<leader>o', group = 'Run / Tasks', icon = { icon = ' ', color = 'yellow' }, mode = { 'n', 'x' } },
