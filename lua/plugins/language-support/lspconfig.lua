    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gE', require('telescope.builtin').lsp_type_definitions, 'Go to Type Definition')
      ...
      local _publish_diagnostics = vim.lsp.handlers['textDocument/publishDiagnostics']
      ...
      vim.list_extend(ensure_installed, { 'stylua', 'clang-format', 'ruff', 'shfmt', 'shellcheck' })
